...
protected:
    ...
    virtual void Set_MOTION(short nActionIdx,
        float fMoveSpeed = 0,
...
public:
    ...
    virtual void PushCommandMove(WORD wSrvDIST, const D3DVECTOR& PosTO, int iServerTarget) = 0 {
        *(int*)0 = 10;
    };
    virtual void PushCommandAttack(int iServerTarget, WORD wSrvDIST, const D3DVECTOR& PosTO) = 0 {
        *(int*)0 = 10;
    };
    ...
    virtual void PushCommandSkill2Obj(WORD wSrvDIST,
        const D3DVECTOR& PosTO,
        int iServerTarget,
        short nSkillIDX) = 0 {
        *(int*)0 = 10;
    };
    virtual void PushCommandSkill2Pos(const D3DVECTOR& PosGOTO, short nSkillIDX) = 0 {
        *(int*)0 = 10;
    };
