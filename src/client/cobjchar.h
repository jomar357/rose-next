...
public:
    ...
    void SetCombatAttackIntent(int iServerTarget, WORD wSrvDIST, const D3DVECTOR& PosGOTO);
    void StartConfirmedCombatSwing(int iServerTarget,
        WORD wSrvDIST,
...
private:
    ...
    struct stPENDING_PROJECTILE_SKILL {
        DWORD m_dwCreateTime;
        int iServerTarget;
        int iSkillIDX;
    };

    std::vector<stPENDING_PROJECTILE_SKILL> m_PendingProjectileSkillList;
...
public:
    ...
    void PushEffectedSkillToList(int iSkillIDX,
        ...
        bool bDamageEventAlreadyQueued = false,
        bool bWaitForProjectileImpact = false);
    void ProcTimeOutEffectedSkill();
    bool ProcEffectedSkill(bool bProjectileImpact = false,
    ...
    /////////////////////////////////////////////////////////////////////////////////
    /// Server-authored combat damage presentation queue
private:
...
public:
    ...
    /// Update recent monster membership without changing HP or presenting hits.
    void UpdateCombatCrowdState(DWORD now);
    /// Present bounded extra melee damage at a real hit frame while in a crowd.
...
public:
    ...
    void Dead();
    bool ProcessSkillHit(CObjCHAR* pFromOBJ, int iSkillIDX);
