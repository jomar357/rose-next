...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::UpdateHeight(CObjCHAR* pObj)
//--------------------------------------------------------------------------------
{
    m_pObj = pObj;
    assert(m_pObj);
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::AdjustHeight_AvatarCart(void)
//--------------------------------------------------------------------------------
{
    if (!InitializePC())
        return;
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::AdjustHeight_OtherCart(void)
//--------------------------------------------------------------------------------
{
    if (!InitializePC())
        return;
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::AdjustHeight_AvatarCgear(void)
//--------------------------------------------------------------------------------
{
    if (!InitializePC())
        return;
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::AdjustHeight_OtherCgear(void)
//--------------------------------------------------------------------------------
{
    if (!InitializePC())
        return;
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::AdjustHeight_Avatar()
//--------------------------------------------------------------------------------
{
    if (!InitializePC(true))
        return;
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::AdjustHeight_Other()
//--------------------------------------------------------------------------------
{
    if (!InitializePC())
        return;
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::AdjustHeight_Monster(void)
//--------------------------------------------------------------------------------
{
    ...
    if (pPatch) {
        ...
        if (CollisionResponseMonster(pPatch)) {
            ...
            m_vCurrent.z =
                g_pTerrain->GetHeightTop(m_vCurrent.x, m_vCurrent.y) + m_pObj->m_fAltitude;
...
bool
CObjCHAR_Collision::CollisionResponseMonster(CMAP_PATCH* pPatch) {
...
bool
CObjCHAR_Collision::ReviseMonsterPosition(tagCYLINDERINFO* Cylinder) {

    float distance;

    distance =
        sqrtf((m_vCurrent.x - Cylinder->m_Position.x) * (m_vCurrent.x - Cylinder->m_Position.x)
            + (m_vCurrent.y - Cylinder->m_Position.y) * (m_vCurrent.y - Cylinder->m_Position.y));
...
//--------------------------------------------------------------------------------
bool
CObjCHAR_Collision::InitializePC(bool bIsAvatar)
//--------------------------------------------------------------------------------
{
    if (!bIsAvatar) {
        assert(m_pObj);
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::Initialize(void)
//--------------------------------------------------------------------------------
{
    assert(m_pObj);
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::SetSpheres_Avatar(void)
//--------------------------------------------------------------------------------
{
    ...
    /*	::InputSceneSphere(m_vFoot.x ,m_vFoot.y, m_vFoot.z, AVATAR_FOOT_RADIUS);
        ::InputSceneSphere(m_vBodyFront.x ,m_vBodyFront.y, m_vBodyFront.z,
       AVATAR_BODY_FRONT_RADIUS);
        ::InputSceneSphere(m_vFootFront.x ,m_vFootFront.y, m_vFootFront.z,
       AVATAR_FOOT_FRONT_RADIUS); */

    m_Spheres.push_back(CollisionSphere(CollisionState::CS_FOOT, m_vFoot, AVATAR_FOOT_RADIUS));
    m_Spheres.push_back(
        CollisionSphere(CollisionState::CS_BODY_FRONT, m_vBodyFront, AVATAR_BODY_FRONT_RADIUS));
    m_Spheres.push_back(
        CollisionSphere(CollisionState::CS_FOOT_FRONT, m_vFootFront, AVATAR_FOOT_FRONT_RADIUS));
}

//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::SetSpheres_Other(void)
//--------------------------------------------------------------------------------
{
    m_vFoot.x = m_vCurrent.x;
    m_vFoot.y = m_vCurrent.y;
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::SetSpheres_AvatarCart(void)
//--------------------------------------------------------------------------------
{
    ...
    m_Spheres.push_back(
        CollisionSphere(CollisionState::CS_BODY_FRONT, m_vBodyFront, CART_BODY_FRONT_RADIUS));
    m_Spheres.push_back(
        CollisionSphere(CollisionState::CS_FOOT_FRONT, m_vFootFront, CART_FOOT_FRONT_RADIUS));
}

//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::SetSpheres_AvatarCgear(void)
//--------------------------------------------------------------------------------
{
    ...
    m_Spheres.push_back(
        CollisionSphere(CollisionState::CS_BODY_FRONT, m_vBodyFront, CGEAR_BODY_FRONT_RADIUS));
    m_Spheres.push_back(
        CollisionSphere(CollisionState::CS_FOOT_FRONT, m_vFootFront, CGEAR_FOOT_FRONT_RADIUS));
}

//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::SetSpheres_OtherCart(void)
//--------------------------------------------------------------------------------
{
    m_vFoot.x = m_vCurrent.x;
    m_vFoot.y = m_vCurrent.y;
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::SetSpheres_OtherCgear(void)
//--------------------------------------------------------------------------------
{
    m_vFoot.x = m_vCurrent.x;
    m_vFoot.y = m_vCurrent.y;
...
//--------------------------------------------------------------------------------
bool
CObjCHAR_Collision::CollisionCallback_Avatar(HNODE hNodeIn)
//--------------------------------------------------------------------------------
{
...
//--------------------------------------------------------------------------------
bool
CObjCHAR_Collision::CollisionCallback_Other(HNODE hNodeIn)
//--------------------------------------------------------------------------------
{
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::CollectContact(CollisionCallback callbackFunc)
...
//--------------------------------------------------------------------------------
{
    ...
    vMin.x =
        (m_vPrevious.x < m_vCurrent.x) ? (m_vPrevious.x - m_fRadius) : (m_vCurrent.x - m_fRadius);
    vMin.y =
        (m_vPrevious.y < m_vCurrent.y) ? (m_vPrevious.y - m_fRadius) : (m_vCurrent.y - m_fRadius);
    vMin.z = (m_vPrevious.z < m_vCurrent.z) ? (m_vPrevious.z - MAX_GRAVITY_HEIGHT)
                                            : (m_vCOM.z - MAX_GRAVITY_HEIGHT);
    ...
    for (int iC = 0; iC < iNumCollidableObjects; ++iC) {
        ...
        if (::isA(hNode, ZZ_TYPE_TERRAIN) || ::isA(hNode, ZZ_TYPE_OCEAN)
            || ::isDescendantOfType(hNode, ZZ_TYPE_MODEL)) {
            continue;
        }
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::GetCollisionState(void)
//--------------------------------------------------------------------------------
{
    CollisionSphere* sp;
    HNODE hNode;
    ...
    for (std::vector<CollisionSphere>::iterator it = m_Spheres.begin(); it != m_Spheres.end();
         ++it) {
        sp = &(*it);
        prevCenter = sp->center - m_vVelocity;

        for (std::vector<HNODE>::iterator itnode = m_ContactNodes.begin();
             itnode != m_ContactNodes.end();
             ++itnode) {
            hNode = (*itnode);
            ...
            if (sp->state == CollisionState::CS_BODY_FRONT) {
                ...
                if (getHeightCollisionLevelOnOff(hNode))
                    continue;
                if (::intersectNodeTriSphereMoving(hNode,
                        sp->center,
                        sp->radius,
                        prevCenter,
                        closestCenter,
                ...
                /*
                if ( !ZZ_IS_MOVEABLE(collisionLevel) && ::intersectNodeTriSphere( hNode, sp->center,
                sp->m_fRadius )) { // collided not moveable object sp->collided.push_back( hNode );
                ...
                */
                ...
                sp->collided.push_back(hNode);
                if (isFalling
                    && ::intersectNodeTriSphereMoving(hNode,
                        sp->center,
                        sp->radius,
                        prevCenter,
                        closestCenter,
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::GetCollisionStateAvatar(void)
//--------------------------------------------------------------------------------
{
    CollisionSphere* sp;
    HNODE hNode;
    ...
    for (std::vector<CollisionSphere>::iterator it = m_Spheres.begin(); it != m_Spheres.end();
        ...
        for (std::vector<HNODE>::iterator itnode = m_ContactNodes.begin();
            ...
            if (sp->state == CollisionState::CS_BODY_FRONT) {
                ...
                if (BodyRay) {
                    distance_ =
                        ::shootRayVec3(hNode, 1 /* nearest */, rayOriginBody, DIRECTION_MOVE);
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::GetCollisionStateCart(void)
//--------------------------------------------------------------------------------
{
    CollisionSphere* sp;
    HNODE hNode;
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::CollisionResponseBody_Cart(void)
//--------------------------------------------------------------------------------
{
    float vRotation[4];
...
//--------------------------------------------------------------------------------
bool
CObjCHAR_Collision::CollisionResponseBodyHeight(HNODE hNode)
//--------------------------------------------------------------------------------
{
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::CollisionResponseBody_Cgear(void)
//--------------------------------------------------------------------------------
{
    StopMovingForCollision();
}
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::CollisionResponseBody_Avatar(void)
//--------------------------------------------------------------------------------
{
    float vRotation[4];
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::CollisionResponseBody_Other(void)
//--------------------------------------------------------------------------------
{
...
//--------------------------------------------------------------------------------
bool
CObjCHAR_Collision::ApplySliding(void)
//--------------------------------------------------------------------------------
{
    ...
    const float fMinDampHeight =
        1.0f; // 최소 1 cm 이하 아래로 내려갈 시에는 움직이는 거리 보정 안 함.

    if (g_pTerrain->GetNormal(m_vCOM.x, m_vCOM.y, vTerrainNormal)) {

        Direction2DLength =
            sqrtf(vTerrainNormal.x * vTerrainNormal.x + vTerrainNormal.y * vTerrainNormal.y);
        ...
        /*		if (0) { // 경사도에 따른 속도 변화 코드 무시. 서버와 동기가 안 맞아서 여러 문제
           생김. fSliding = 1.f + fSlopeDot; // 평지에서는 1. 경사가 위로 급할수록 0, 아래로
           급할수록 2가 된다.
                    ...
                    if ( m_vNext.z > m_vPrevious.z - fMinDampHeight ) {
                        ...
                        float fMoveLength = sqrtf( vDirection.x * vDirection.x + vDirection.y *
           vDirection.y );
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::CollisionResponseFoot_Avatar(void)
//--------------------------------------------------------------------------------
{
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::CollisionResponseFoot_Cart(void)
//--------------------------------------------------------------------------------
{
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::CollisionResponseFoot_Cgear(void)
//--------------------------------------------------------------------------------
{
    m_vNext.z = m_fTerrainHeight;
    UpdateFootHeight_Avatar();
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::CollisionResponseFoot_Other(void)
//--------------------------------------------------------------------------------
{
    m_vNext.z = m_fTerrainHeight;
    UpdateFootHeight_Avatar();
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::CollisionResponseNone_Other(void)
//--------------------------------------------------------------------------------
{
    m_vNext.z = m_fTerrainHeight;
    m_pObj->SetCollisionGroundNode(NULL);
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::CollisionResponseNone_Cart(void)
//--------------------------------------------------------------------------------
{
    m_vNext.z = m_fTerrainHeight;
    m_pObj->SetCollisionGroundNode(NULL);
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::CollisionResponseNone_Cgear(void)
//--------------------------------------------------------------------------------
{
    m_vNext.z = m_fTerrainHeight;
    m_pObj->SetCollisionGroundNode(NULL);
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::CollisionResponseNone_Avatar(void)
//--------------------------------------------------------------------------------
{
    m_vNext.z = m_fTerrainHeight;
    m_pObj->SetCollisionGroundNode(NULL);
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::UpdateFootHeight_Avatar(void)
//--------------------------------------------------------------------------------
{
    CollisionSphere* sp;
    float distance;
    ...
    for (std::vector<CollisionSphere>::iterator it = m_Spheres.begin(); it != m_Spheres.end();
         ++it) {
        sp = &(*it);
        if (sp->state != CollisionState::CS_FOOT)
            continue;

        for (std::vector<HNODE>::iterator itnode = sp->collided.begin();
             itnode != sp->collided.end();
             ++itnode) {
            // down
            distance = ::shootRayVec3Ex((*itnode),
                1 /* nearest */,
                rayOriginDown,
                DIRECTION_DOWN,
                ContactPoint,
    ...
    if (GradientOnOff) {
        ...
        if (!((angle < 3.141592f * 0.3f) || SlideOnOff)) {
            ...
            if ((ContactMeshHeight > ((m_vCOM.z - m_vFoot.z) * 0.7f + m_vFoot.z))
                && !m_footCollisionPass)
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::UpdateFootHeight_Other(void)
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::UpdatePositionAfterCollision(void)
//--------------------------------------------------------------------------------
{
    //	ApplyGravity();
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::UpdatePositionAfterNonCollision(void)
//--------------------------------------------------------------------------------
{
    ApplyGravity();
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::StopMovingForCollision(void)
//--------------------------------------------------------------------------------
{
    if (m_pObj->m_fCurMoveSpeed == 0)
        return;
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::ApplyGravity(void)
//--------------------------------------------------------------------------------
{
    // apply gravity
...
//--------------------------------------------------------------------------------
void
CObjCHAR_Collision::ApplyTerrainNormal(float fTerrainX, float fTerrainY)
//--------------------------------------------------------------------------------
{
    D3DXVECTOR3 vTerrainNormal;
