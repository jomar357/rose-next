...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_00(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
    // 사용안함.
    return false;
}
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_01(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
    /*
    struct		AICOND01
    {
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_02(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
    ...
    while (pFindCHAR) {
        if ((pAIParam->m_pSourCHAR != pFindCHAR)
            && (bAllied == pAIParam->m_pSourCHAR->Is_ALLIED(pFindCHAR))) {
            if (pAIParam->m_pSourCHAR->Get_LEVEL() - pFindCHAR->Get_LEVEL() >= pCond->nLevelDiff
                && pAIParam->m_pSourCHAR->Get_LEVEL() - pFindCHAR->Get_LEVEL()
                    <= pCond->nLevelDiff2) {
                iFindCNT++;
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_03(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return false;
#endif
    /*
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_04(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
    /*
    struct		AICOND04
    {
        DWORD			dwSize ;					// 이 스트럭쳐의 크기
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_05(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
    /*
    struct		AICOND05
    {
        DWORD			dwSize ;					// 이 스트럭쳐의 크기
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_06(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
    /*
    struct		AICOND06
    {
        DWORD			dwSize ;					// 이 스트럭쳐의 크기
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_07(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
    /*
    struct		AICOND07
    {
        DWORD			dwSize ;					// 이 스트럭쳐의 크기
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_08(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return false;
#endif
    ...
    struct		AICOND08
    {
        ...
        AITYPE			Type ;						// 조건 타입
        int				iDistance ;					// 거리
        char			cLevelDiff ;				// 레벨차 (-128~127 ) 자신의 레벨보다
    cLevelDiff이상인 BYTE			cChrType ;					// 캐릭터 타입 (아바타=0,몬스터=1)
    } ;
    */
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_09(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
    /*
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_10(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
    /*
    ...
    */
    ...
    // 반드시 타겟이 존재해야 한다.
    if (NULL == pAIParam->m_pSourCHAR->Get_TARGET() || NULL == pAIParam->m_pDestCHAR)
        return false;
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_11(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
    /*
    ...
    struct		AICOND11
    {
        ...
        BYTE			cAbType ;		// 능력치 (레벨=0, 공격력=1, 방어력=2, 항마력=3, HP=4,
    매력=5) int				iValue;			// 비교값. 이값보다 큰가/작은가. 이런식으로 BYTE
    cMoreLess ;		// 큰=0 , 작은=1 } ;
    */
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_12(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
    /*
    /// 현재 존이 지금 낮인가 / 밤인가 ?
    struct		AICOND12
    {
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_13(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
/*
/// 자신/타겟에게 걸려있는 상태 체크.
struct		AICOND13
{
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_14(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
/*
// NPC 변수 체크	- AICOND14
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_15(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
/*
// 월드변수 체크	- AICOND15
typedef struct	tagValue
{
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_16(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
/*
// 경제 데이터 체크 - AICOND16
typedef struct	tagValue
{
...
//-------------------------------------------------------------------------------------------------
bool
F_AICOND_17(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
/*
/// NPC 선택
struct AICOND17
{
...
bool
F_AICOND_18(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
#ifndef __SERVER
    return false;
#else
...
bool
F_AICOND_19(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
#ifndef __SERVER
    return false;
#else
...
bool
F_AICOND_20(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
...
struct AICOND20
{
    ...
    int		iValue;	// 비교할 데이터값 (iType의 능력치 Op iValue)
    BYTE	btOp;	// iData값에 대한 비교방법. 0 = 같다, 1 = 크다, 2 = 크거나 같다. 3=작다,
4=작거나 같다.
};
*/
#ifndef __SERVER
...
bool
F_AICOND_21(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
#ifndef __SERVER
    return false;
#else
...
bool
F_AICOND_22(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
#ifndef __SERVER
    return false;
#else
...
bool
F_AICOND_23(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
    /// 월드시각 체크
...
bool
F_AICOND_24(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
/*
/// 날짜 + 시각 체크
struct AICOND24
{
...
bool
F_AICOND_25(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
/*
/// 요일 + 시각 체크
struct AICOND25
{
...
bool
F_AICOND_26(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
...
bool
F_AICOND_27(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
/*
 * Struct Name : AICOND_27
 * 주변캐릭터 상황 체크
 * Explain : 체크범위 iDistance이내에 캐릭터타입 cChrType이고 레벨차가 cLevelDiff이상이고 캐릭터수가
wChrNum이상/이하인 경우 truct		AICOND27			// 2번 조건하고 비슷...
{
    DWORD		dwSize ;
    AITYPE		Type ;
    int			iDistance ;		// 체크거리
    ...
    WORD		wChrNum ;		// 캐릭터 숫자
    BYTE		btOp;			// 캐릭터 숫자에 대한 OP (0 = 같다, 1 = 크다, 2 = 크거나 같다.
3=작다, 4=작거나 같다.) } ;
*/
#ifdef __SERVER
...
bool
F_AICOND_28(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
/*
// 몬스터 변수 체크
struct	AICOND28
{
...
// 공격자 / 공격타겟이 클랜마스터인가 ?
bool
F_AICOND_29(stCondHead* pConDATA, t_AIPARAM* pAIParam) {
