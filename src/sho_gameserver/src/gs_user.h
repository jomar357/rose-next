...
public:
    ...
    VisibleStatSnapshot visible_stat_snapshot();
    bool sync_update_stats_if_visible_stats_changed(const VisibleStatSnapshot& before);
    bool update_ability_and_sync_if_visible_stats_changed();
    ...
    bool send_update_hpmp(bool include_hp, bool include_mp);
...
private:
    ...
    bool Use_PackageITEM(tagITEM* pITEM, short nInventoryIDX);
