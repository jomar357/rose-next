...
| U9 | jCodeMunch index of this checkout | User's global instructions | Not indexed on 2026-09-24 (docs-only session). | Run `index_folder` before the first code-exploration task. |
